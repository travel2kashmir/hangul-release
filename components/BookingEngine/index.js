...
function BookingEngine({ color, allHotelDetails, rooms, display, setDisplay, setShowModal, setSearched, checkinDate, checkoutDate, roomsLoader, setRoomsLoader }) {
    ...
    return (
        <>
            ...
            {display === 0 ? <RoomCalenderView color={color} roomsLoader={roomsLoader} setRoomsLoader={(e) => setRoomsLoader(e)} allRoomRateDetails={allRoomRateDetails} dataOfRoomsAsPerDateSelected={dataAsPerDate} rooms={rooms} setDisplay={(e) => setDisplay(e)} setShowModal={(e) => setShowModal(e)} setSearched={(e) => setSearched(false)} checkinDate={checkinDate} checkoutDate={checkoutDate} /> : undefined}
            {display === 1 ? <RoomSummary color={color} setDisplay={(e) => setDisplay(e)} setShowModal={(e) => setShowModal(e)} setSearched={(e) => setSearched(false)} checkinDate={checkinDate} checkoutDate={checkoutDate} /> : undefined}
            {display === 2 ? <Reviewbooking color={color} setDisplay={(e) => setDisplay(e)} property_id={allHotelDetails?.property_id} rooms={rooms} setShowModal={(e) => setShowModal(e)} setSearched={(e) => setSearched(false)} checkinDate={checkinDate} checkoutDate={checkoutDate} /> : undefined}
