...
function BookingForm({ setShowModalBookingForm, setShowBookingEngine, enquiry, setEnquiry, setRoomsLoader, setSearched, searched, cookie }) {
                            ...
                            onClick={() => {
                                if (enquiry.checkin === "" && enquiry.checkout === "") {
                                    ...
                                    if (cookie) {
                                        ...
                                        global.analytics.track(`User searching for room`, {
                                            action: `User searching for room`,
