                        ...
                        <li>
                            <div className="flex items-center">
                                <div className={`${color?.textgray} text-base font-medium  inline-flex items-center`}>
                                    <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                                    <span className="text-gray-400 ml-1 md:ml-2 font-medium text-sm  " aria-current="page">Edit {language?.addons}</span>
                                </div>
                            </div>
                        </li>
                    </ol>
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <div className={visible === 1 ? 'block' : 'hidden'}>
                                            <input
                                                ...
                                                defaultValue={activeAddon?.addon_name} required
                                                onChange={
                                                    (e) => (
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <div className={visible === 1 ? 'block' : 'hidden'}>
                                            <input
                                                ...
                                                className={`shadow-sm ${color?.greybackground} border border-gray-300 ${color?.text} sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5`}
                                                defaultValue={activeAddon?.addon_description} required
                                                onChange={
                                                    (e) => (
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <div className={visible === 1 ? 'block' : 'hidden'}>
                                            <input
                                                type="text" data-testid="test_addon_description"
                                                className={`shadow-sm ${color?.greybackground} border border-gray-300 ${color?.text} sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5`}
                                                defaultValue={activeAddon?.addon_for} required
                                                onChange={
                                                    (e) => (
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <div className={visible === 1 ? 'block' : 'hidden'}>
                                            <input
                                                type="text" data-testid="test_addon_description"
                                                className={`shadow-sm ${color?.greybackground} border border-gray-300 ${color?.text} sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5`}
                                                defaultValue={activeAddon?.provider_id} required
                                                onChange={
                                                    (e) => (
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <div className={visible === 1 ? 'block' : 'hidden'}>
                                            <input
                                                type="text" data-testid="test_addon_description"
                                                className={`shadow-sm ${color?.greybackground} border border-gray-300 ${color?.text} sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5`}
                                                defaultValue={activeAddon?.price_per_unit} required
                                                onChange={
                                                    (e) => (
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <div className={visible === 1 ? 'block' : 'hidden'}>
                                            <input
                                                type="text" data-testid="test_addon_description"
                                                className={`shadow-sm ${color?.greybackground} border border-gray-300 ${color?.text} sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5`}
                                                defaultValue={activeAddon?.serves_to} required
                                                onChange={
                                                    (e) => (
