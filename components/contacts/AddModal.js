...
import { validationContact } from '../logic/property/Contact';

function AddModal({ view, setView, language, color, error, setError, flag, setFlag, spinner, setSpinner, setSpin, contact, setContact, setContacts, countryCode, setCountryCode, currentProperty, propertyName, setGen, setVisible, Router }) {
    return (
