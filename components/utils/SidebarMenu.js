...
function SidebarMenu({ color, Primary, language, Type }) {
  const [ari, setAri] = useState(false)
  const [services, setServices] = useState(false)
  const [addon, setAddon] = useState(false)
  return (
    <div className={`${color.whitebackground} relative flex-1 flex flex-col min-h-0 border-r border-gray-200  pt-0`}>
      <div className="flex-1 flex flex-col  pb-4 overflow-y-auto">
        <div className={`${color.whitebackground} flex-1 py-4 px-3 divide-y space-y-1`}>
          <ul className="space-y-2 pb-2">
            ...
            {/* dashboard  */}
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2`}>
              <svg
              ...
              <span className="ml-3">
                <Link href={{ pathname: Primary?.dashboard, query: { id: 1 } }}><a>{language?.dashboard} </a></Link> </span>
            </li>

            {/* inbox  */}
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2`}>
              <svg className={`w-6 h-6  ${color.textgray} flex-shrink-0  ${color.iconhover} transition duration-75`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>

              <span className="ml-3"><Link href={{ pathname: Primary?.inbox, query: { id: 1 } }}><a>{language?.inbox} </a></Link> </span>
            </li>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  `}>
              ...
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.basicdetails, query: { id: 1 } }}><a> {language?.basicdetails}</a></Link>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 `}>
              <svg
                className={`w-7 h-7  ${color.textgray} flex-shrink-0  ${color.iconhover} transition duration-75`}
                fill="currentColor"
                viewBox="0 0 32 32"
                xmlns="http://www.w3.org/2000/svg"
              >
	...
	C26,7.5,21.5,3,16,3z M16,17c-2.2,0-4-1.8-4-4s1.8-4,4-4s4,1.8,4,4S18.2,17,16,17z"
              ...
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.address, query: { id: 1 } }}><a>{language?.address}</a></Link></span>
            </li>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              <svg
                className={`w-5 h-5 ${color.textgray} flex-shrink-0  ${color.iconhover} transition duration-75`}
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.contact, query: { id: 1 } }}><a>{language?.contact}</a></Link></span>
            </li>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              ...
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.gallery, query: { id: 1 } }}><a>{language?.gallery}</a></Link></span>
            </li>
	...
	l13.091-12.761C55.838,22.336,55.936,21.939,55.818,21.578z"
              ...
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.reviews, query: { id: 1 } }}><a>{language?.reviews}</a></Link></span>
            </li>
            ...
            <li>
              <button type="button" onClick={() => { setServices(!services) }}
                className={`${color.text} ${color.sidebar} group  rounded-lg flex items-center p-2 
            w-full text-base font-normal  transition duration-75`} >
              ...
              <div className={services === true ? 'block' : 'hidden'}>
                <ul className="py-2 space-y-2">
                  <li className={`${color.text}  text-base font-normal rounded-lg flex items-center p-2 pl-11`}
                  >
                    <Link href={{ pathname: Primary?.services, query: { id: 1 } }}>
                      <a>{language?.basicservices}</a></Link>
                  </li>
                  <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                    <Link href={{ pathname: Primary?.additionalservices, query: { id: 1 } }}>
                      <a
                      >
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              ...
              <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.rooms, query: { id: 1 } }}>
                  <a>
                    {language?.rooms}</a>
                </Link></span>
            </li>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              ...
              <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.roomsprices, query: { id: 1 } }}>
                  <a>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              ...
              <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.unavailability, query: { id: 1 } }}>
                  <a>
                    {language?.outofservice}</a>
                </Link></span>
            </li>
            {/* bookings */}
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              ...
              <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.bookings, query: { id: 1 } }}>
                  <a>
                    {language?.bookings} </a>
                </Link></span>
            </li>
            ...
            <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
              ...
              <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
              <span className="ml-3 flex-1 whitespace-nowrap">
                <Link href={{ pathname: Primary?.tc, query: { id: 1 } }}>
                  <a>
            ...
            {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
                ...
                <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
                <span className="ml-3 flex-1 whitespace-nowrap">
                  <Link href={{ pathname: Primary?.places, query: { id: 1 } }}>
                    <a>
                      {language?.places}</a>
                  </Link></span>
              </li> */}
            ...
            w-full p-2 text-base font-normal  transition duration-75`} >
                ...
                <div className={addon === true ? 'block' : 'hidden'}>
                  <ul className="py-2 space-y-2">
                    <li className={`${color.text}  text-base font-normal rounded-lg flex items-center p-2 pl-11`}
                    >
                      <Link href={{ pathname: Primary?.addons, query: { id: 1 } }}>
                        <a>{language?.addons}</a></Link>
                    </li>
                    <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                      <Link href={{ pathname: Primary?.providers, query: { id: 1 } }}>
                        <a
                        >
                      ...
                      <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                      <Link href={{ pathname: Primary?.itineraries, query: { id: 1 } }}>
                        <a>
                      ...
                      <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                      <Link href={{ pathname: Primary?.packages, query: { id: 1 } }}>
                        <a
                        >
                          {language?.packages}</a>
                      </Link></li>
            ...
            w-full p-2 text-base font-normal  transition duration-75`} >
                    ...
                    <div className={ari === true ? 'block' : 'hidden'}>
                      <ul className="py-2 space-y-2">
                        {/* <li className={`${color.text}  text-base font-normal rounded-lg flex items-center p-2 pl-11`}
                        >
                          <Link href={{ pathname: Primary?.availability, query: { id: 1 } }}>
                            <a>{language?.availability}</a></Link>
                        </li> */}
            {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                          <Link href={{ pathname: Primary?.inventory, query: { id: 1 } }}>
                            <a
                            >
                              {language?.inventory}</a>
                          </Link></li> */}
            {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                          <Link href={{ pathname: Primary?.promotion, query: { id: 1 } }}>
                            <a
                            >
                              {language?.promotions}</a>
                          </Link></li> */}
            {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                          <Link href={{ pathname: Primary?.modification, query: { id: 1 } }}>
                            <a
                            >
                              {language?.ModificationCols?.name}</a>
                          </Link></li> */}
            {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2 pl-11`}>
                          <Link href={{ pathname: Primary?.extraguestcharge, query: { id: 1 } }}>
                            <a
                            >
            ...
            {JSON.stringify(Type) === "2" ? <></> :
              <>
                ...
                {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
                    <svg className={`w-6 h-6 ${color.textgray} flex-shrink-0  ${color.iconhover} transition duration-75`}
                    ...
                    <span className="ml-3 flex-1 whitespace-nowrap">
                      <Link href={{ pathname: Primary?.roombundle, query: { id: 1 } }}>
                ...
                {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
                    ...
                    <span className="ml-3 flex-1 whitespace-nowrap">
                      <Link href={{ pathname: Primary?.raterules, query: { id: 1 } }}>
                ...
                {/* <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
                    <svg className={`w-6 h-6 ${color.textgray} flex-shrink-0  ${color.iconhover} transition duration-75`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-2 0c0 .993-.241 1.929-.668 2.754l-1.524-1.525a3.997 3.997 0 00.078-2.183l1.562-1.562C15.802 8.249 16 9.1 16 10zm-5.165 3.913l1.58 1.58A5.98 5.98 0 0110 16a5.976 5.976 0 01-2.516-.552l1.562-1.562a4.006 4.006 0 001.789.027zm-4.677-2.796a4.002 4.002 0 01-.041-2.08l-.08.08-1.53-1.533A5.98 5.98 0 004 10c0 .954.223 1.856.619 2.657l1.54-1.54zm1.088-6.45A5.974 5.974 0 0110 4c.954 0 1.856.223 2.657.619l-1.54 1.54a4.002 4.002 0 00-2.346.033L7.246 4.668zM12 10a2 2 0 11-4 0 2 2 0 014 0z" clipRule="evenodd"></path></svg>
                    <span className="ml-3 flex-1 whitespace-nowrap">
                      <Link href={{ pathname: Primary?.pointofsale, query: { id: 1 } }}>
              ...
              {/* {JSON.stringify(Type) === "2" ? <></> :
                  <>
                    <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
                      ...
                      <span className="ml-3 flex-1 whitespace-nowrap">
                        <Link href={{ pathname: Primary?.propertyxml, query: { id: 1 } }}>
                    ...
                    <li className={`${color.text} ${color.sidebar} group text-base font-normal rounded-lg flex items-center p-2  group`}>
                      ...
                      <span className="ml-3 flex-1 whitespace-nowrap">
                        <Link href={{ pathname: Primary?.roomsxml, query: { id: 1 } }}>
