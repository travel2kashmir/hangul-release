...
import ItinerariesData from '../components/devlopmentjson/ItinerariesData.json';
let colorToggle;
let language;
let currentProperty;
let currentLogged;
    ...
    return (
        <>
            ...
            >
                ...
                <div className="mx-4">
                    <h1 className={`text-xl sm:text-2xl font-semibold ${color?.text}`}>Itineraries</h1>
                        ...
                        <div className=" sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                            ...
                            <form className="lg:pr-3" action="#" method="GET">
                                ...
                                <div className="mt-1 relative lg:w-64 xl:w-96">
                                    <input type="text" name="email" id="Itinput" onKeyUp={() => searchFunction('Itinput', 'ItTable')}
                        ...
                        <div className="overflow-x-auto">
                            <div className="align-middle inline-block min-w-full">
                                <div className="shadow overflow-hidden">
                                    <table className="table data table-fixed lg:min-w-full divide-y divide-gray-200 min-w-screen" id="ItTable">
                                        <thead className={`${color?.tableheader}`}>
                                            <tr>
                                                ...
                                                <th scope="col" className={`p-4 text-left text-xs font-semibold ${color?.text} uppercase`}>Itinerary Name</th>
                                                <th scope="col" className={`p-4 text-left text-xs font-semibold ${color?.text} uppercase`}>Actions</th>
                                                <th scope="col" className={`p-4 text-left text-xs font-semibold ${color?.text} uppercase`}></th>
                                            </tr>
                                        </thead>
                                            ...
                                            {ItinerariesData?.map((itinerary, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td className={`${color?.text} p-4 whitespace-nowrap capitalize text-base font-normal`}>{itinerary?.itinerary_name}</td>

                                                        <td className="py-4 whitespace-nowrap capitalize">
                                                            <div onClick={() => localStorage.setItem("itinerary",JSON.stringify(itinerary))}>
                                                                <Link href="./itinerary/accomodations">
                                                                <a> <button className="bg-gradient-to-r bg-green-600 hover:bg-green-700 text-white  sm:inline-flex font-semibold rounded-lg text-sm px-5 py-2 text-center items-center ease-linear transition-all duration-150"
                                                                >Accomodation </button>
                                                                </a>
                                                            </Link>
                                                        ...
                                                        <td className="py-4 whitespace-nowrap capitalize">
                                                            <div
                                                             onClick={() => localStorage.setItem("itinerary",JSON.stringify(itinerary))}> 
                                                            <Link href="./itinerary">
