...
function Addons() {
    ...
    function editAddOn() {
        ...
        setAddons([...unchangedAddons, activeAddon]);
        setActiveAddon({});
        setEditaddon(0);
    }
    //new addon
    function newAddOn() {
        setAddons([...addons, activeAddon]);
        setActiveAddon({});
        setEditaddon(0);
    }
    return (
        <>
            ...
            {editaddon === 0 ?
                <div id="main-content"
                    ...
                    <div className="mx-4">
                        <h1 className={`text-xl sm:text-2xl font-semibold ${color?.text}`}>Addons</h1>
                            ...
                            <div className=" sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                                ...
                                <form className="lg:pr-3" action="#" method="GET">
                                    ...
                                    <div className="mt-1 relative lg:w-64 xl:w-96">
                                        <input type="text" name="email" id="addonInput" onKeyUp={() => searchFunction('addonInput', 'addonTable')}
                            ...
                            <div className="overflow-x-auto">
                                <div className="align-middle inline-block min-w-full">
                                    <div className="shadow overflow-hidden">
                                        <table className="table data table-fixed lg:min-w-full divide-y divide-gray-200 min-w-screen" id="addonTable">
                                            <thead className={`${color?.tableheader}`}>
                                                <tr>
                                                    ...
                                                    <th scope="col" className={`p-4 text-left text-xs font-semibold ${color?.text} uppercase`}>ADDON Name</th>
                                                ...
                                                {addons?.map((addon, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td className={`${color?.text} p-4 whitespace-nowrap capitalize text-base font-normal`}>{addon.addon_name}</td>
